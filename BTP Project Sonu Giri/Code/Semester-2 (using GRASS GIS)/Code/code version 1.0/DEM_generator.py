...
def DEM_creator(H, H_wt, seed, elev_range,sigma,gradient, max_level, DEMcreator_option):
    ...
    DEM_arr = DEM_arr[0:2001,0:1201] # For temorary purpose
    Output = [DEM_arr, Input_DEMs, name, parameter] 
    return Output

#For testing purpose
#if __name__ == "__main__":
#    arr = DEM_creator(H=[0.7,0.8,0.9], H_wt=[0.3,0.4,0.2], seed=[5,7,31], elev_range=[200,1000],sigma=1,gradient=0, max_level=11, DEMcreator_option='SS')
#    print 'works okk'
